...
class RMTEncoderForSequenceClassification():
    ...
    def set_params(self, 
        ...
        self.base_model.encoder.forward = types.MethodType(lambda *args, **kwargs: encoder_memory_forward(*args, **kwargs, memory_storage=self.memory_storage), self.base_model.encoder)
    ...
    def __call__(self, input_ids, **kwargs):
        ...
        if self.sum_loss:
            ...
            for i, o in enumerate(outputs):
                out[f'loss_{i}'] = o['loss'].mean().cpu().item()
