...
class RMTEncoderDecoderForConditionalGeneration():
    ...
    def from_pretrained(from_pretrained, **kwargs):
        ...
        base_model = T5ForConditionalGeneration.from_pretrained(from_pretrained, **kwargs)
        rmt = RMTEncoderDecoderForConditionalGeneration(base_model=base_model)
        return rmt
        

    def set_params(self, model_attr='t5', input_size=None, input_seg_size=None, num_mem_tokens=0, bptt_depth=-1, pad_token_id=0, 
                    eos_token_id=1,
                    cls_token_id=101, 
                    sep_token_id=102):
