...
from lm_experiments_tools import TrainerArgs, Trainer
# from lm_experiments_tools.trainer_sv_grad import Trainer
...
if __name__ == '__main__':
    ...
    ### booydar
    batch_metrics_fn = lambda _, y: {key: y[key] for key in y.keys() if ('loss' in key) or ('grad' in key)}
