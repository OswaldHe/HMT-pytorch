...
class QualityBinaryClassification(Dataset):
    ...
    def __getitem__(self, idx):
        x = self.data[idx]['query'].strip() + ' ' + self.data[idx]['answer'].strip() + ' ' + self.data[idx]['context']
...
def main():
    ...
    train_dataset = QualityBinaryClassification(data_path)
    ...
    if args.valid_data_path:
        ...
        valid_dataset = QualityBinaryClassification(valid_data_path)
    ...
    if args.test_data_path:
        ...
        test_dataset = QualityBinaryClassification(test_data_path)
