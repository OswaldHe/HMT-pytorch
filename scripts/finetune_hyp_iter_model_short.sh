...
horovodrun --gloo -np $NP python run_finetuning_hyp_rmt.py \
        ...
        --model_path ../runs/finetune/debug/hyperpartisan_news_detection/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${INPUT_SIZE}_mem${MEMORY_SIZE}_seg${INPUT_SEG_SIZE}/run_$N \
