...
MAX_N_SEGMENTSS=(8 9 10 11 12 13 14 15 20 32 64 128 256 512 1024 2048)
...
horovodrun --gloo -np $NP python run_finetuning_babilong_random_rmt_memtest.py \
        --model_path ../runs/test/${TASK_NAME}/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${INPUT_SEQ_LEN}-${TGT_LEN}-{$MAX_N_SEGMENTS}seg_mem${MEMORY_SIZE}_bs${TBS}_iters${ITERS}_${SEGMENT_ORDERING}_memtest_eval/run_$N \
