...
accelerate launch /home/yingqi/repo/HMT-pytorch/tools/training/fine_tunning.py \
    ...
    --num_seg_save=8 \
    --batch_size=1 \
    --save_dir=/home/yingqi/scratch/c00/checkpoints/fine_tuning/qwen2.5-0.5b/musique \
    --save_interval=20 \
    ...
    --load_from_ckpt="/home/yingqi/scratch/c00/hmt_pretrained/qwen2.5-0.5b/model_weights_0_lv_2.pth"
