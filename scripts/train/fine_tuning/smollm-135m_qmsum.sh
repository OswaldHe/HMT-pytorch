...
export CHECKPOINT=/home/yingqi/scratch/checkpoints/fine_tuning/smollm-135m/qmsum/model_weights_1961.pth
...
accelerate launch $HMT_PYTORCH_PATH/tools/training/fine_tunning.py \
    ...
    --save_dir=/home/yingqi/scratch/checkpoints/fine_tuning/smollm-135m/qmsum_second_half \
    --save_interval=40 \
    --token_file=huggingface_token.txt \
    --validation_interval=40 \
    --validation_steps=50 \
    --wandb_run=qmsum_fine_tuning_smollm_second_half \
