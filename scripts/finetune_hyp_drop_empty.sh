...
INPUT_SIZES=(998 1227 )
MEMORY_SIZES=(10 100 )

LR=1e-05
SCHEDULER=linear
MODEL_CLS=modeling_rmt_drop_empty:RMTEncoderForSequenceClassification
...
horovodrun --gloo -np $NP python run_finetuning_hyp_rmt.py \
        ...
        --model_path ../runs/finetune/hyperpartisan_news_detection/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${INPUT_SIZE}_mem${MEMORY_SIZE}_drop_empty/run_$N \
