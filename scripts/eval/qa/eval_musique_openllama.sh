...
export FINETUNED_CHECKPOINT=/home/yingqi/scratch/hmt_pretrained/openllama_3b_v2/openllama-musique/model_weights_1301.pth
...
accelerate launch --main_process_port $MAIN_PROCESS_PORT ${HMT_PYTORCH_PATH}/hmt_tools/evaluation/eval.py \
    ...
    --is_qa_task \
    --max_context_length=16000000 \
    --save_generated_texts=musique_openllama_3b_v2_finetuned.csv \
