...
export FINETUNED_CHECKPOINT=/home/yingqi/scratch/hmt_pretrained/smollm-135m/smollm-musique/model_weights_901.pth
...
accelerate launch  ${HMT_PYTORCH_PATH}/tools/evaluation/eval.py \
    ...
    --save_generated_texts=musique_smollm_zeroshot.csv \
...
accelerate launch  ${HMT_PYTORCH_PATH}/tools/evaluation/eval.py \
    ...
    --is_qa_task \
    --max_context_length=16000000 \
    --save_generated_texts=musique_smollm_finetuned.csv \
