...
""" Copy-pasted from Transformers 4.17.0 """
        ...
        if self.is_cross_attention:
            ...
            if getattr(config, 'use_lora', False):
                try:
                    ...
                    raise ImportError('Install loralib to use LoRA! https://github.com/microsoft/LoRA')
    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            if len(attention_mask.shape) == 2:
                ...
                # custom mask with shape [bs, from_seq_length, to_seq_length]
